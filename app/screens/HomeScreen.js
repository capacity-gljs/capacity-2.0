  ...
  render() {
    ...
    return (
     ...
     <SafeAreaView style = {styles.safeArea}>
      ...
      <Text style={styles.modalText}>{locDescription.rating } ({locDescription.user_ratings_total})</Text>
      <Text style={styles.modalType}> {getType(type)} {dollarSign(locDescription.price_level)}</Text>
      <Text 
         style={{
          marginBottom: 5, 
          fontSize: 15,
          color: getColor(hours)}}>{isOpen(hours)}</Text>
        <TouchableHighlight 
